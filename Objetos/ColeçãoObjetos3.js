...
var tamanho_colecao = curiosidades_chuck_norris.length; //obtem tamanho total de objetos

var numero_sorteado = Math.floor(Math.random() * tamanho_colecao);
//math.random() Retorna um número aleatório entre 0 <1 Ex N = 0,3  
//Math.floor() Arredonda para menor  número inteiro mais próximo

var curiosidade_escolhida = curiosidades_chuck_norris[numero_sorteado];//Variavel recebe tamanho da colecao e o numero aleatorio
